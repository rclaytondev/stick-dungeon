...
Player.prototype.update = function() {
	...
	if(keys[65] && this.invSlots[this.activeSlot].content !== "empty") {
		...
		else if(this.invSlots[this.activeSlot].content instanceof RangedWeapon) {
			if(this.aimRot === null) {
				this.aimRot = 0;
					...
					roomInstances.push(
						new Room(
							...
							[
								...
								new Block(700, -200, 500, 1000), //right wall
					...
					roomInstances.push(
						new Room(
							...
							[
								...
								new Block(-2000, -1900, 4000, 1500), //roof
...
var roomInstances = [
	new Room(
		"ambient",
		[
			new Block(-200, 500, 2000, 600), 
			new Block(-400, -200, 700, 900),
...
Particle.prototype.exist = function() {
	...
	//circle(this.x + p.worldX, this.y + p.worldY, 5);
...
function MagicCharge(x, y, velX, velY, type) {
	this.x = x;
	this.y = y;
	this.velX = velX;
	this.velY = velY;
